...
TARGET_DIR = r"C:\ExcelWorkspace\Input"        
RESULT_FILE = r"C:\ExcelWorkspace\Output\출하검사 기록관리 대장.xlsx" 
...
def send_ecount_html_email(smtp_server, smtp_port, sender_email, sender_password, receiver_emails, today_df, available_cols):
    ...
    <p style="font-family: 'Malgun Gothic'; font-size: 12px; color: #666666;">※ 상세 원본 파일은 <b>C:\\ExcelWorkspace\\Output</b> 폴더에 저장되었습니다.</p></body></html>"""
...
if is_streamlit_mode:
    ...
    default_index = USER_LIST_FORMATTED.index("조경석 (kscho@absfil.com)")
    
    selected_sender_raw = strl.selectbox("보내는 사람 (발신인 단일 선택)", options=USER_LIST_FORMATTED, index=default_index)
